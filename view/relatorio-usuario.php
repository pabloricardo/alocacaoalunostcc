				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li class="active"><a href="#">Relatório de Usuário<span class="sr-only">(current)</span></a></li>
			...
			<form id="relatorio-form">
				<div class="panel panel-default col-md-offset-1 col-md-10">
					<div class="panel-heading">
						<h1 class="panel-title text-center">Relatório de Usuário</h1>
					</div>
					...
					<div class="panel-footer text-right">
						<button class="btn btn-default" type="reset" onclick="focusPrimeiroCampo('table-relatorio-usuario');">Limpar</button>
						<button class="btn btn-primary" id="btn-pesquisar" type="submit">Pesquisar</button>
					</div>
				</div>
			</form>

		<div id="table-relatorio-usuario" class="table-info display-none col-md-offset-1 col-md-10 padding-left-right-none">
			<div class="panel">
...
<script type="text/javascript">
  ...
  $("#tabela").table2excel({
    ...
    filename: "Relatório de Usuário" //do not include extension
		...
		<script>
			$(document).ready(function(){
				$('#btn-pesquisar').click(function(){
					...
					jQuery.ajax({
						type: "POST",
						url: "../model/relatorio-usuario.php",
						data: dados,
						success: function(data)
						{
							$('tbody').html(data);
							$("#table-relatorio-usuario").show();
						}
					});			
					return false;
				});
